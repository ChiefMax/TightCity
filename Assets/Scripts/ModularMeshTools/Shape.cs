...
namespace Demo
{
    ...
    public abstract class Shape : MonoBehaviour
    {
        ...
        public void Generate(float delaySeconds = 0, bool isAsian = false, bool isOdd = false)
        {
            DeleteGenerated();
        ...
        protected abstract void ExecuteAsian();
        protected abstract void ExecuteAsianRoof();
    }
}